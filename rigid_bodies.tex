...
This procedure is shown to reproduce a canonical ensemble compatible with the refined system, but canonical averages regarding the original system can be easily recovered by reweighting.
...
The horizontal dotted lines are meant to help visualize the departure of the computed properties from their expected values, which correspond to average results obtained with $\timestep = 1~\text{fs}$ for the three refined methods (details below).
