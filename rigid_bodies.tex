...
In this section, we analyze the integration schemes introduced in Subsection~\ref{sec:numerical_solvers} and compare the results with those obtained employing the method of Kamberaj~\cite{Kamberaj2005}. For that, we simulated a system containing 356 TIP3P water molecules\cite{Price2004} at a density of 999.56 $kg/m^3$. The intermolecular interactions were truncated at 9 \AA. The shifted-force (SF) method\cite{Allen1989, Fennell2006, Toxvaerd_2011} was used to treat both the Coulombic and the 12-6 Lennard-Jones (LJ) interactions.
