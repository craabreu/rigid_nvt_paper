...
As we manage to prove here, their findings can be extended to the symplectic integration of rigid-body motion as well.
...
Having overcome such barrier is of paramount importance as it allows one to actually exploit the high numerical stability and useful coarse-graining strategy provided by rigid-body MD.
