...
In this paper, we have devised an approach that integrates the powerful machinery of backward error analysis into Nos\'{e}-Hoover chains dynamics and global stochastic thermostats.
A valuable enhancement is achieved with a simple approximation of the shadow Hamiltonian: in the case of TIP3P water, we have been able to overcome the serious disruptions observed in the schemes of Martyna \textit{et al}. \cite{Martyna_1996} and Kamberaj \textit{et al}. \cite{Kamberaj_2005}, correcting the discretization effects in numerically computed averages for time-step sizes up to 5 fs.
