...
It should be emphasize that this novel technique is not limited to rigid bodies, neither to the NHC method.
...
It is also known that $\Ham{S}$ explicitly depends on the time-step size $\timestep$.
...
We have also (check ensemble results)\ref{table:check_ens}
