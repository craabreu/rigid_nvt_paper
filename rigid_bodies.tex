...
The factorization which played a central role in Ref.~\citenum{Silveira_2017} is ${\mt A}(\vt q) = \tr{\mt B}(\vt q) {\mt C}(\vt q)$, where ${\mt A}(\vt q)$ is the rotation matrix that connects the body-fixed and space-fixed frames.
