...
%Finally, $\modified K$ is the total kinetic energy of the system, whose computation (not using Eq.~\eqref{eq:kinetic energy}, hence the distinct symbol) is the central feature of the method we propose.
