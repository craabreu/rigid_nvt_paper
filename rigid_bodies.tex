...
From Fig.~\ref{fig:properties} it becomes clear that the Refined schemes yields significantly improved results: we are able to simultaneously reproduce the specified temperature and the other thermodynamic properties.
...
Fig.~\ref{fig:energy_partition} (a) was obtained directly from the contribution of translational and rotational degrees of freedom to the refined kinetic energy.
It confirms that our approximation bla bla bla
After reweighting, which yields Fig.~\ref{fig:energy_partition} (b), it becomes clear that our method corrects, for time-step sizes up to 5 fs, the serious disruption observed in the schemes of \citeauthor{Martyna_1996} \cite{Martyna_1996} and  \citeauthor{Kamberaj_2005} \cite{Kamberaj_2005}
