...
Error bars were obtained using the Overlapping Batch Means estimator \cite{Meketon_1984, Flegal_2010} and standard uncertainty propagation formulas.
...
First, for the sake of comparison, we test our measure-preserving extension to rigid bodies of the method of Martyna \textit{et al}. \cite{Martyna_1996} without doing any refinement, such as detailed in Sec.~\ref{sec:nvt}.
Another method we use with no refinement is that of Kamberaj \textit{et al}. \cite{Kamberaj_2005}.
We will show that, besides the spurious energy flux between the thermostats, such method exhibits some discretization-related issues....................................

We have included the results of applying our method, but using the approximate solution of rotation due to Miller \textit{et al}. \cite{Miller_2002}, which is denoted as ``Refined/NO-SQUISH''.
Recall that the computed averages for both refined schemes are obtained via reweighting by employing Eq.~\eqref{eq:reweighting}.
